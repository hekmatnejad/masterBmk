...
//                    "\n" +
        ...
        drl += rule;
//        ksession = KBLoader.createKBfromDrlSource(drl, engine);
...
//        FactType inputObject = ksession.getKieBase().getFactType( "opencds.benchmarking.phreak", "InputObject" );
...
//        assertEquals(0,KBLoader.clearVM(ksession,false));
